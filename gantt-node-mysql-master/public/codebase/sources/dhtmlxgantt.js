...
gantt.locale = {
	...
	labels:{
		...
		confirm_deleting:"Você deseja realmente excluir esta atividade?",
        section_description:"Descrição",
        section_time:"Período da atividade",
		section_type:"Tipo",
		...
		/* link confirmation */
		link: "A ligação entre ",
		confirm_link_deleting:"será deletada",
		link_start: " (start)",
		link_end: " (end)",
